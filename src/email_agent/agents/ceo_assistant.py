...
class CEOAssistantAgent:
    ...
    def __init__(self):
        ...
        self.investor_domains = ['sequoia.com', 'a16z.com', 'accel.com', 'greylock.com', 'ycombinator.com']
        self.key_relationship_patterns = ['founder', 'ceo', 'cto', 'advisor', 'board member', 'investor']
    ...
    async def analyze_for_ceo(self, email: Email) -> Dict[str, Any]:
        ...
        try:
            response = await self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are an expert executive assistant specializing in helping startup CEOs manage their communications efficiently. You understand startup dynamics, investor relations, and CEO priorities. Always return valid JSON."},
            ...
            if any(pattern in sender_lower for pattern in self.key_relationship_patterns):
    ...
    async def suggest_time_blocks(self, analyses: List[Dict[str, Any]]) -> Dict[str, List[Dict[str, Any]]]:
